...
def stale_templates(day_dir: Path | str) -> list[str]:
    ...
    Those assets were not old either: the gallery redesign landed 2026-07-14 and
    the newest previews were rendered 2026-08-07, three weeks after. So the
    silent case costs nothing on the real data and the loud one cost the whole
    signal. Every render from here leaves a stamp, so a future design change is
    caught by evidence rather than by absence.
