...
to copy verbatim. Remember the words "scene", "act", etc. are
...
- (May 2, 2026) When tagging a performer or ensemble whose social handle isn't self-explanatory, write the full name first and put the handle in parentheses immediately after, for example 'William Paterson University Choir (@wp_voice)', rather than leading with the bare handle as if it stands in for the name.
