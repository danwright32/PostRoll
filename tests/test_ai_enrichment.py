...
def test_enrich_program_passes_url_hint_to_prompt(sample_photo):
    ...
    def fake_run(prompt, timeout=900, allowed_dirs=None, allowed_tools=None):
...
def test_caption_passes_shoot_type_to_prompt(sample_photo):
    ...
    def fake_run(prompt, timeout=300, allowed_dirs=None, allowed_tools=None):
        captured["prompt"] = prompt
...
def test_blog_passes_shoot_type_to_prompt(sample_photo):
    ...
    def fake_run(prompt, timeout=600, allowed_dirs=None, allowed_tools=None):
        captured["prompt"] = prompt
